...
for c = 1:10
    for i = 1:1000
        simus6a(i, :) = Simu_Expe(congr_list(c), Alpha_list6a(i,:), beta_list6a(i), 2, 40);
        simus3a(i, :) = Simu_Expe(congr_list(c), Alpha_list3a(i,:), beta_list3a(i), 2, 40);
        simus4aO(i, :) = Simu_Expe(congr_list(c), Alpha_list4aO(i,:), beta_list4aO(i), 2, 40);
        simus4aP(i, :) = Simu_Expe(congr_list(c), Alpha_list4aP(i,:), beta_list4aP(i), 2, 40);
    end
...
save('SimusAnalysis2.mat', 'simus_summary');
save('SimusAnalysis2.mat', 'means_summary');