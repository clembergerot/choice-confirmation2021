file_name = 'ParamSumAnalysis1.mat';
...
for i = 1:1000
    [output1, output2] = Simu_Expe(conglevel, Alpha_list4aO(i,:), beta_list4aO(i), 2, 40);
    simus4aO(i, :) = output1;
    qvals4aO(1, i, :) = output2(1, :);
    qvals4aO(2, i, :) = output2(2, :);
    [output1, output2] = Simu_Expe(conglevel, Alpha_list4aP(i,:), beta_list4aP(i), 2, 40);
    simus4aP(i, :) = output1;
...
save('SimusAnalysis1Type2sim.mat', 'simus_summary');
save('SimusAnalysis1Type2mean.mat', 'means_summary');

qvals_summary = table(qvals4aO, qvals4aP);
qmeans_summary = table(mean_qvals4aO, mean_qvals4aP);
save('SimusAnalysis1Type2simQ.mat', 'qvals_summary');
save('SimusAnalysis1Type2meanQ.mat', 'qmeans_summary');